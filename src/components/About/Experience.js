...
const Experience = () => (
  ...
  >
    ...
    <div className="mt-8 md:ml-1">
      <div className="flex flex-col gap-5 mt-4 ml-4 text-lg md:flex-row text-secondaryColor md:gap-[450px] md:ml-0">
        <h3>
        ...
        <p className="md:mr-3">
          <img src={modeliaLogo} alt="microverse-logo" className="inline w-8" />
          {' '}
          Modelia
    ...
    <div className="mt-8 md:ml-1">
      ...
      <ul className="ml-4 md:ml-0">
        <li className="flex gap-2 mt-4 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Enhanced and maintained a client portal, adding features, bug fixes,
            and testing.
          </p>
        </li>
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Built an admin portal from scratch for efficient user, device, and
        ...
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Collaborated with the team to optimize UI/UX, performance, and
            deliver features under tight deadlines.
          </p>
        </li>
      </ul>
    </div>
    <div className="mt-8 md:ml-1">
      ...
      <ul className="ml-4 md:ml-0">
        <li className="flex gap-2 mt-4 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Revamped the Kwanzoo dashboard with a modern UI, migrating to a new
            front-end project.
          </p>
        </li>
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Optimized API performance by creating ElasticSearch snapshots,
        ...
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Developed new features & fixed critical issues used by 20+ B2B
            clients.
          </p>
        </li>
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Led end-to-end implementation – from development to testing & AWS
            deployment.
          </p>
        </li>
      </ul>
    ...
    <div className="mt-8 md:ml-1">
      ...
      <ul className="ml-4 md:ml-0">
        <li className="flex gap-2 mt-4 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Reviewed 100+ projects from junior developers, ensuring they met
        ...
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Provided code quality improvements and best practices for
        ...
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>
            Assisted developers in debugging, refactoring, and writing clean,
            maintainable code.
          </p>
        </li>
      </ul>
    ...
    <div className="mt-8 ml-1 md:ml-0">
      ...
      <ul className="ml-4 md:ml-2">
        ...
        <li className="flex gap-2 mt-2 text-base text-skyColor">
          <ChevronRightIcon className="h-6" />
          <p>Build websiite using Wordpress and Shopify for my clients.</p>
        </li>
      </ul>
    </div>
  </motion.div>
