...
const Experience = () => {
  return (
    ...
    <div className="mt-8">
      ...
      <p><img src={microverseLogo} alt="microverse-logo" className="inline w-8"/> Microverse<span className="block text-sm text-skyColor">Remote</span></p>
      </div>
    ...
    <div className="mt-14">
      ...
      <h3>Mentor (Volunteer) <span className="block text-sm ml-1 text-skyColor">November 2021 – December 2021</span></h3>
      <p><img src={microverseLogo} alt="microverse-logo" className="inline w-8"/> Microverse <span className="block text-sm text-skyColor">Remote</span></p>
      </div>
    ...
    <div className="mt-14">
      ...
      <h3>Freelance Developer<span className="block text-sm ml-1 text-skyColor">January 2020 – September 2021 &#160; &#160;</span></h3>
      <p><img src={freelanceLogo} alt="microverse-logo" className="inline w-8"/> Freelance <span className="block text-sm text-skyColor">Remote</span></p>
      </div>
