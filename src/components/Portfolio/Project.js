    ...
    <div className="md:flex project-card mt-24 mx-2 md:mx-0 p-3 shadow shadow-lightBlueColor md:gap-5">
      ...
      <div>
        ...
        <div className={`flex ${even ? 'md:justify-start' : 'md:justify-end'} gap-5 text-skyColor mt-5 ml-2 md:ml-0`}>
          <a target="_blank" href={live} className="bg-lightBlueColor rounded px-5 py-2 text-md text-skyColor font-medium" rel="noreferrer">
            See Live
            <img src={serverLogo} className="w-5 inline ml-2 mb-1" alt="server-icon" />
          </a>
          <a target="_blank" href={github} className="bg-lightBlueColor rounded px-5 py-2 text-md text-skyColor font-medium" rel="noreferrer">
            See Source
