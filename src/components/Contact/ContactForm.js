    ...
    <div className="flex flex-col mt-10 ml-6 md:ml-0 md:items-center md:mr-52">
      ...
      focus:border-2 focus:border-secondaryColor focus:outline-none" />
        ...
        <textarea  rows="10" name="user_msg" required maxlength="500"
          placeholder="Write your message here" className="w-72 md:w-80 p-2 rounded text-primaryColor
          focus:border-2 focus:border-secondaryColor focus:outline-none"></textarea>
